...
namespace TinyPngApi.Core
{
    public static class TinifyHelperExtensions
    {
        ...
        public static async Task<List<TinifyApiKeyPair>> GenerateTinifyApiKeysOnlineAsync()
        {
        ...
        public static async Task SaveCompressRemainCountAsync(this List<TinifyApiKeyPair> listTinifyApiKeyPair)
        {
            foreach (var key in listTinifyApiKeyPair)
            {
                 await SaveCompressRemainCountAsync(key);
